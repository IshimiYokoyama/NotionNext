...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '橘枳Karatachi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '摸索中……', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://databasebenchmarkblog.netlify.app/', // 网站地址
